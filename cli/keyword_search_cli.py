...
def main() -> None:
    ...
    tf_parser = subparsers.add_parser(
        "tf", help="Get the term frequency for a given document and term"
    )
    ...
    tfidf_parser = subparsers.add_parser(
        "tfidf",
        help="Get the term frequency-inverse document frequency for a given document and term",
    )
    ...
    match args.command:
        ...
        case "tf":
            ...
            print(
                f"Term frequency for document {args.doc_id} and term {args.term}: {tf}"
            )
        case "idf":
        ...
        case "tfidf":
            print("Getting term frequency-inverse document frequency...")
